...
<body>
	...
	<div class="carousel slide" data-ride="carousel">
		<div class="carousel-inner">
			...
			<div class="carousel-item"><img src="img/skyBG.jpg"></div>
	...
	<div class="container">
		<div class="row justify-content-center text-center">
			<div class="col-10 py-5">
				...
				<p class="lead">All that we are is the result of what we have thought.<br>Martin Luther king jr king eyyy</p><a class="btn btn-purple btn-lg" href="https://nl.wikipedia.org/wiki/Martin_Luther_King" target="_blank">CLICK</a>
			</div>
		</div>
	</div>
	<!--- BOOTSTRAP UDEMY COURSE -->
	...
	<div class="container py-3">
		<div class="row justify-content-center py-5">
			<div class="col-lg-6">
				<h3 class="pb-4">Today on Channel 6 NEWS</h3>
				<p>The will automatically stack on top of each other when the screen is less than 992px wide.</p>
			...
			<div class="col-lg-6"><img class="img-fluid" src="img/yellowBG.jfif"></div>
		</div>
	</div>
