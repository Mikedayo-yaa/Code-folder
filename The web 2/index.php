	...
	<div class="container">
		<div class="row justify-content-center text-center">
			<div class="col-10 py-5">
				<h2>Mike,s world world west best website is nu Online !!</h2>
				<p class="lead">The lord mike,s World world website is one of the new websites on the web all you,re problems we solve with help of Good data bases and such.</p><a class="btn btn-purple btn-lg" href="https://w3newbie.com/courses/" target="_blank">W3NEWBIE COURSES</a>
			</div>
		</div>
	</div>
	<!--- BOOTSTRAP UDEMY COURSE -->
